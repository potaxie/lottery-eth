let {bytecode, interface} = require('./contract-compile')
...
// let terms = 'only donor crash lend glass arrange observe escape shine wine retreat sad'

let terms ='truly state fruit rug decide riot shy lake apple orphan october dinosaur' //直接使用 ganache 助记词也是可以的
